...
screen = pg.display.set_mode([width + border + int(width/4),height + border])                           # Set up the display with size defined by width and height of the grid, plus the border so when cells are drawn it does not get cut off the edges and plus a fourth of the width to display text
...
text_ins7 = font3.render("ESC - End Game",1,color)              # TEXT FOR Instruc7         color "color"   antialias = 1
...
while 1:                                                                            # Main loop of the game, if it ends (and the only way is through a break statement), the game ends
    ...
    text_i = font2.render(str(i),1,color)                           # TEXT FOR number of iterations         color "color"   antialias = 1
    ...
    screen.blit(text_game, (width + border + int(width/8) - text_game.get_width() // 2, int(height/20)*1 - text_game.get_height() // 2))
    screen.blit(text_of, (width + border + int(width/8) - text_of.get_width() // 2, int(height/20)*2 - text_of.get_height() // 2))
    screen.blit(text_life, (width + border + int(width/8) - text_life.get_width() // 2, int(height/20)*3 - text_life.get_height() // 2))
    screen.blit(text_dim, (width + border + int(width/8) - text_dim.get_width() // 2, int(height/20)*6 - text_dim.get_height() // 2))
    screen.blit(text_cellst, (width + border + int(width/8) - text_cellst.get_width() // 2, int((height/20)*7.5) - text_cellst.get_height() // 2))
    screen.blit(text_cells, (width + border + int(width/8) - text_cells.get_width() // 2, int((height/20)*8.5) - text_cells.get_height() // 2))
    screen.blit(text_it, (width + border + int(width/8) - text_it.get_width() // 2, int((height/20)*9.5) - text_it.get_height() // 2))
    screen.blit(text_i, (width + border + int(width/8) - text_i.get_width() // 2, int((height/20)*10.5) - text_i.get_height() // 2))
    screen.blit(text_ins1, (width + border + int(width/8) - text_ins1.get_width() // 2, int((height/20)*15) - text_ins1.get_height() // 2))
    screen.blit(text_ins2, (width + border + int(width/8) - text_ins2.get_width() // 2, int((height/20)*15.5) - text_ins2.get_height() // 2))
    screen.blit(text_ins3, (width + border + int(width/8) - text_ins3.get_width() // 2, int((height/20)*16) - text_ins3.get_height() // 2))
    screen.blit(text_ins4, (width + border + int(width/8) - text_ins4.get_width() // 2, int((height/20)*16.5) - text_ins4.get_height() // 2))
    screen.blit(text_ins5, (width + border + int(width/8) - text_ins5.get_width() // 2, int((height/20)*17) - text_ins5.get_height() // 2))
    screen.blit(text_ins6, (width + border + int(width/8) - text_ins6.get_width() // 2, int((height/20)*17.5) - text_ins6.get_height() // 2))
    screen.blit(text_ins7, (width + border + int(width/8) - text_ins7.get_width() // 2, int((height/20)*18) - text_ins1.get_height() // 2))
